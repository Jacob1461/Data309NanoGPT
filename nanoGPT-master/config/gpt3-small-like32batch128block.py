...
wandb_run_name = 'GPT3-small-like32batch128blockNODROP'

dataset = 'lyrics'
gradient_accumulation_steps = 1
batch_size = 32 # rough estimate  of the number of tokens in a sentence
block_size = 128 #estimate of the number of lines in a pop song
